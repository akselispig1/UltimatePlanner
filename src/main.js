// App entry. The app is a single full-screen chat whose one job is to put things
// on the user's Google Calendar. A gear opens the setup sheet for keys.
...
function renderHeader() {
  ...
  bar.appendChild(el('button', { class: 'icon-btn hdr', title: 'Setup', onClick: () => openSettings(App), html: ICONS.settings }));
}
...
// Read-only introspection hooks for the headless check. No secrets pass through.
